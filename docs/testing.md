...
BLT also supports the bundling and execution of phpunit tests from locations outside of the tests folder. See the [PHPUnit Configuration](#phpunit) section below for additional information. 
